...
public class MockCreator {
    ...
    private static long developerCount = 0;
    private static long teamLeadCount = 0;
    private static long productOwnerCount = 0;
    ...
    private List<Long> getDeveloperIdList(int size) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            developer.setEmail(String.format(developerCount + "user%d@user.dev", i));
    ...
    private List<Long> getTeamLeadsIdList(int size) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            teamLead.setEmail(String.format(teamLeadCount + "user%d@user.tm", i));
    ...
    private List<Long> getProductOwnerIdList(int size) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            owner.setEmail(String.format(productOwnerCount + "user%d@user.ownr", i));
